class number5 : AlignWidget, EventReceiver
{
	...
	public static number5 create(AlignWidget app) {
		var v = new number5();
		v.app = app;
		return(v);
	}
		...
		if(o!=null) {		
			if(o is String) {
				...
				if(i.equals("main")) { //BACK
					...
					s.show(this, number6.create(AlignWidget.instance()), CrossFadeTransition.instance());			
				}				
