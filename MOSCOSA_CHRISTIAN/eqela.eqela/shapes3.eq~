class shapes3 : AlignWidget, EventReceiver
{
	...
	public override void initialize() {
		...
		add_align(0, 0, ImageButtonWidget.instance().set_image(Image.resize(Image.icon("circle"),57,56)));
	...
	public void tick() {
		if(timer != 0) {
			...
			Popup.widget(get_engine(),DialogWidget.message("YOU ONLY GOT TWO(2) POINTS","ATTENTION!", "back",true).set_listener(this));		
		}
		invalidate();
	}
}		
