class number4 : AlignWidget, EventReceiver
{
	...
	public static number4 create(AlignWidget app) {
		var v = new number4();
		v.app = app;
		return(v);
	}
			...
			if(o!=null) {		
				if(o is String) {
					...
					if(i.equals("main")) { //BACK
						...
						s.show(this, number5.create(AlignWidget.instance()), CrossFadeTransition.instance());			
					}				
