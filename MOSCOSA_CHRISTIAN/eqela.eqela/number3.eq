class number3 : AlignWidget, EventReceiver
{
	...
	public static number3 create(AlignWidget app) {
		var v = new number3();
		v.app = app;
		return(v);
	}
	public override void initialize() {
		...
		//REVISIONS
		add_align(0, -0.8, y= LabelWidget.instance().set_text("Quiz#3").set_color(Color.instance("#000000")).set_font(Font.instance("10mm")));
		add_align(0, -0.2, y= LabelWidget.instance().set_text("3 + 1 = ?").set_color(Color.instance("#000000")).set_font(Font.instance("7mm")));
		...
		if(o!=null) {		
			if(o is String) {
				...
				if(i.equals("main")) { //BACK
					...
					s.show(this, number4.create(AlignWidget.instance()), CrossFadeTransition.instance());			
				}				
