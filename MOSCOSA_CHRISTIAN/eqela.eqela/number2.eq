class number2 : AlignWidget, EventReceiver
{
	...
	public static number2 create(AlignWidget app) {
		var v = new number2();
		v.app = app;
		return(v);
	}
		...
		if(o!=null) {		
			if(o is String) {
				...
				if(i.equals("main")) { //BACK
					...
					s.show(this, number3.create(AlignWidget.instance()), CrossFadeTransition.instance());			
				}				
